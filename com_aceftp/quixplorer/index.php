...
//------------------------------------------------------------------------------
require JPATH_ROOT .'/'. JPATH_QUIX ."/_include/init.php";	// Init
//------------------------------------------------------------------------------
switch($GLOBALS["action"]) {		// Execute action
//------------------------------------------------------------------------------
// EDIT FILE
case "edit":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_edit.php";
	edit_file($GLOBALS["dir"], $GLOBALS["item"]);
break;
//------------------------------------------------------------------------------
// DELETE FILE(S)/DIR(S)
case "delete":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_del.php";
	del_items($GLOBALS["dir"]);
break;
//------------------------------------------------------------------------------
// COPY/MOVE FILE(S)/DIR(S)
case "copy":	case "move":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_copy_move.php";
...
case "download":
	...
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_down.php";
...
case "upload":
	...
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/$upload_script";
	upload_items($GLOBALS["dir"]);
break;
//------------------------------------------------------------------------------
// UNZIP ZIP FILE added by laurenceHR
case "unzip":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_unzip.php";
	unzip_item($GLOBALS["dir"]);
break;
//------------------------------------------------------------------------------
// CREATE DIR/FILE
case "mkitem":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_mkitem.php";
	make_item($GLOBALS["dir"]);
break;
//------------------------------------------------------------------------------
// CHMOD FILE/DIR
case "chmod":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_chmod.php";
	chmod_item($GLOBALS["dir"], $GLOBALS["item"]);
break;
//------------------------------------------------------------------------------
// SEARCH FOR FILE(S)/DIR(S)
case "search":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_search.php";
	search_items($GLOBALS["dir"]);
break;
//------------------------------------------------------------------------------
// CREATE ARCHIVE
case "arch":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_archive.php";
	archive_items($GLOBALS["dir"]);
break;
//------------------------------------------------------------------------------
// USER-ADMINISTRATION
case "admin":
	require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/fun_admin.php";
...
case "list":
default:
	require JPATH_ROOT .'/'. JPATH_QUIX ."/_include/fun_list.php";
