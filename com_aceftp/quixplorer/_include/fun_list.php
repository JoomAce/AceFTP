...
//?? CK			$link = $GLOBALS["home_url"]."/".get_rel_item($dir, $item);
	...
	// Icon + Link
		...
		echo "align=\"ABSMIDDLE\" src=\"".JPATH_QUIX_SHORT."/_img/".get_mime_type($dir, $item, "img")."\" ALT=\"\">&nbsp;";
...
function list_dir($dir)
{
	...
	include JPATH_ROOT .'/'. JPATH_QUIX . "/_include/javascript.php";
	
	// Sorting of items
	$_img = "&nbsp;<IMG width=\"10\" height=\"10\" border=\"0\" align=\"ABSMIDDLE\" src=\"".JPATH_ROOT ."/". JPATH_QUIX ."/_img/";
	if($GLOBALS["srt"]=="yes") {
