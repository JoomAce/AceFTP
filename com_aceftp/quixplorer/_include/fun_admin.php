...
require JPATH_ROOT . "/" . JPATH_QUIX . "./_include/permissions.php";
...
function admin($admin, $dir)
{
	...
	include JPATH_ROOT . "/" . JPATH_QUIX . "./_include/js_admin.php";
...
function adduser ($dir)
{
	...
	// Javascript functions:
	include JPATH_ROOT . "/" . JPATH_QUIX . "./_include/js_admin2.php";
...
function edituser($dir)
{
	...
	// Javascript functions:
	include JPATH_ROOT . "/" . JPATH_QUIX . "./_include/js_admin3.php";
